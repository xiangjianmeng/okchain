...
func ReadChainConfig(db DatabaseReader, hash common.Hash) *config.ChainConfig {
...
func WriteChainConfig(db DatabaseWriter, hash common.Hash, cfg *config.ChainConfig) {
	if cfg == nil {
		return
	}
