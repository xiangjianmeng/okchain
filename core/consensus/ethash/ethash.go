...
var logger = log.MustGetLogger("ethash")
...
func (d *dataset) generate(dir string, limit int, test bool) {
	d.once.Do(func() {
		...
		//logger := log.MustGetLogger("epoch")
...
func New(config Config) *Ethash {
	if config.CachesInMem <= 0 {
		log.Warning("One ethash cache must always be in memory", "requested", config.CachesInMem)
...
func NewTester() *Ethash {
	return New(Config{CachesInMem: 10, PowMode: ModeTest})
	//return New(Config{CachesInMem: 1, PowMode: ModeFake})
}
