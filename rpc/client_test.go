...
func TestGetAccount(t *testing.T) {
	client, err := DialHTTP("http://127.0.0.1:16014")
	if err != nil {
		panic(err)
	}
	defer client.Close()
	...
	if err := client.Call(&resp, "okchain_getAccount", "0x94dc66c8be8393e41791dfd7b8a47fe43f3e0890"); err != nil {
		t.Fatal(err)
	}
	fmt.Println(resp)
}
...
// This test reproduces https://github.com/ok-chain/okchain/issues/17837 where the
