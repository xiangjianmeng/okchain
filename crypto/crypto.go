...
func GenerateKeyPair() (*ecdsa.PrivateKey, []byte, error) {
	...
	k := hashToInt(privateKeyInByte, curve)
...
func AddECDSAPub(key1 *ecdsa.PublicKey, key2 *ecdsa.PublicKey) (*ecdsa.PublicKey, error) {
	if key1 == nil || key2 == nil {
		return nil, errors.New("key1 or key2 is nil")
	}
	x, y := new(ecdsa.PublicKey).Add(key1.X, key1.Y, key2.X, key2.Y)
