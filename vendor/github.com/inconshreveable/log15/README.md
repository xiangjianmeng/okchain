...
srvlog.Warning("abnormal conn rate", "rate", curRate, "low", lowRate, "high", highRate)
...
srvlog.Warning("abnormal conn rate", log.Ctx{"rate": curRate, "low": lowRate, "high": highRate})
```
